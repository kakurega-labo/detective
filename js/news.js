...
const newsData = [
    {
        ...
        title: "行方不明猫捜索の成功報告",
        description: "米花町5丁目での捜索依頼、無事に発見・保護に至りました。"
    },
    {
        date: "2026.02.28",
        category: "お知らせ",
    ...
    },
    {
        ...
        category: "実績報告",
        categoryClass: "bg-slate-700",
        title: "野辺山・八ヶ岳で発生した一連の事件を解決",
        description: "国立天文台野辺山や八ヶ岳などでの事件を解決しました。",
        content: "南佐久郡南牧村の「国立天文台野辺山」や八ヶ岳連峰などで発生した一連の事件を解決しました。途中、銃撃事件に遭遇するなど非常に危険な状況もありましたが、私は警察の皆さんと協力し、犯人を追い詰めて事件を解決に導くことができました。"
    },
    {
        date: "2025.03.05",
        category: "実績報告",
