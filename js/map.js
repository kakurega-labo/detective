document.addEventListener('DOMContentLoaded', () => {
    ...
    const locations = [
        ...
        { 
            ...
            desc: "ウォーターフロント開発エリアに位置する駅。周辺のオフィス街へのアクセスが良く、モノレールへの乗り換えもスムーズです。", 
            tags: ["駅", "海沿い", "芝浜"], 
            postcode: "〒100-0004", 
            address: "東京都東都区芝浜1丁目",
        ...
        },
        {
            ...
            desc: "港線の始発駅であり、東都環状線との主要接続駅。広大な地下街を有し、都内有数のバスターミナルを併設しています。",
            tags: ["駅", "港線", "ターミナル"],
            postcode: "〒100-0010",
            address: "東京都東都区沢袋1丁目",
        ...
        },
        {
            ...
            desc: "東都中央線の停車駅。周辺は古くからの学生街として知られ、飲食店や書店が多く活気に満ちたエリアです。",
            tags: ["駅", "中央線", "学生街"],
            postcode: "〒100-0011",
        ...
        },
        {
            ...
            desc: "東都環状線の南部に位置する駅。洗練された商業施設やオフィスビルが隣接し、非常に利便性が高いエリアです。",
            tags: ["駅", "東都環状線", "恵木寿"],
            postcode: "〒100-0012",
        ...
        },
        {
            ...
            reviews: "450",
            img: "https://images.unsplash.com/photo-1515165561111-0d39e5572005?w=200",
            desc: "米花駅の北隣に位置する住宅街の最寄り駅。閑静な環境で、通勤・通学客の利用が中心となっています。",
            tags: ["駅", "東都線", "住宅街"],
            postcode: "〒100-0013",
        ...
        },
        {
            ...
            reviews: "320",
            img: "https://images.unsplash.com/photo-1590483734724-38fa19dd6be9?w=200",
            desc: "東都中央線の快速停車駅。駅周辺は再開発が進んでおり、高層マンションと商業施設が一体化した便利な環境です。",
            tags: ["駅", "中央線", "小久保"],
            postcode: "〒100-0014",
        ...
        },
        {
            ...
            reviews: "2900",
            img: "https://images.unsplash.com/photo-1561530931-97b778796850?w=200",
            desc: "若者文化の発信地として知られるエリア。駅前は常に賑わいを見せ、ファッションビルや小規模なブティックが密集しています。",
            tags: ["駅", "東都環状線", "空宿"],
            postcode: "〒150-0001",
            address: "東京都東都区空宿1丁目",
        ...
        },
        {
            ...
            reviews: "980",
            img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200",
            desc: "港線と私鉄が交差する交通の要所。駅周辺は飲食店が密集しており、夜間も多くの人で賑わいます。",
            tags: ["駅", "港線", "乗り換え駅"],
            postcode: "〒156-0001",
            address: "東京都世田谷区鳴大前",
        ...
        },
        {
            ...
            reviews: "540",
            img: "https://images.unsplash.com/photo-1555529733-0e670560f7e1?w=200",
            desc: "東都環状線の北部に位置する駅。閑静な高級住宅街が広がり、都心への通勤・通学客の利用が非常に多いエリアです。",
            tags: ["駅", "東都環状線", "上米花"],
            postcode: "〒100-0021",
            address: "東京都米花市上米花1丁目",
            site: "https://toto-railway.jp/station/kamibeika/",
        ...
        },
        {
            ...
            reviews: "320",
            img: "https://images.unsplash.com/photo-1495001258031-d1b407bc1776?w=200",
            desc: "オフィスビルと住宅が混在する中規模駅。駅前にはスーパーやドラッグストアなどの生活利便施設が充実しています。",
            tags: ["駅", "東都環状線", "東米花"],
            postcode: "〒100-0022",
        ...
        },
        {
            ...
            reviews: "610",
            img: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=200",
            desc: "東都環状線の東側に位置する。近年、IT企業のサテライトオフィス誘致が進んでおり、平日昼間の乗降客数が増加傾向にあります。",
            tags: ["駅", "東都環状線", "天倉"],
            postcode: "〒100-0023",
            address: "東京都東都区天倉町",
        ...
        },
        {
            ...
            reviews: "280",
            img: "https://images.unsplash.com/photo-1515165561111-0d39e5572005?w=200",
            desc: "古くからの町工場と住宅が共存するエリア。駅高架下の商店街には地元密着型の店舗が立ち並びます。",
            tags: ["駅", "東都環状線", "黒沢"],
            postcode: "〒100-0024",
            address: "東京都東都区黒沢町",
        ...
        },
        {
            ...
            reviews: "410",
            img: "https://images.unsplash.com/photo-1590483734724-38fa19dd6be9?w=200",
            desc: "米花大学の最寄り駅の一つ。学生向けの安価な飲食店が多く、活気に満ちた駅前が特徴です。",
            tags: ["駅", "東都環状線", "下米花"],
            postcode: "〒100-0025",
        ...
        },
        {
            ...
            reviews: "720",
            img: "https://images.unsplash.com/photo-1561530931-97b778796850?w=200",
            desc: "東都環状線と地下鉄線の接続駅。広大な地下歩道を通じて主要な商業ビルへ雨に濡れずにアクセス可能です。",
            tags: ["駅", "東都環状線", "香田"],
            postcode: "〒100-0026",
            address: "東京都東都区香田町",
        ...
        },
        {
            ...
            reviews: "380",
            img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200",
            desc: "緑豊かな公園に隣接する駅。週末は家族連れでの利用が多く、落ち着いた雰囲気の駅です。",
            tags: ["駅", "東都環状線", "南大杉"],
            postcode: "〒100-0027",
        ...
        },
        {
            ...
            reviews: "190",
            img: "https://images.unsplash.com/photo-1515165561111-0d39e5572005?w=200",
            desc: "環状線西部の住宅拠点。駅構内に保育施設が併設されており、子育て世代の利便性が考慮されています。",
            tags: ["駅", "東都環状線", "昭江"],
            postcode: "〒100-0028",
            address: "東京都米花市昭江町",
        ...
        },
        {
            ...
            reviews: "260",
            img: "https://images.unsplash.com/photo-1590483734724-38fa19dd6be9?w=200",
            desc: "古くからの繁華街への入口となる駅。小規模な個人商店が立ち立ち並び、情緒ある風景が残っています。",
            tags: ["駅", "東都環状線", "江木"],
            postcode: "〒100-0029",
            address: "東京都米花市江木町",
        ...
        },
        {
            ...
            reviews: "890",
            img: "https://images.unsplash.com/photo-1561530931-97b778796850?w=200",
            desc: "近年大規模な駅前再開発が行われた注目エリア。最新の設備を備えたタワーマンションが林立しています。",
            tags: ["駅", "東都環状線", "耕木"],
            postcode: "〒100-0030",
            address: "東京都米花市耕木1丁目",
        ...
        },
        {
            ...
            reviews: "1100",
            img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200",
            desc: "港線の主要駅。私鉄線との直通運転が行われており、都心部と郊外を結ぶハブ駅として機能しています。",
            tags: ["駅", "港線", "佐々塚"],
            postcode: "〒151-0073",
        ...
        },
        {
            ...
            reviews: "450",
            img: "https://images.unsplash.com/photo-1515165561111-0d39e5572005?w=200",
            desc: "港線の地下駅。商店街が駅の真上に位置し、生活用品の買い物に非常に便利な環境です。",
            tags: ["駅", "港線", "波田ケ谷"],
            postcode: "〒151-0072",
